...
namespace LibraryWebApplication.Controllers
{
    public class BooksIssuesController : Controller
    {
        ...
        {
            if (bookId == null) return RedirectToAction("Create", "BooksIssues");
        ...
        {
            if (libraryId == null) return RedirectToAction("Create", "BooksIssues");
        ...
        {
            if (readerId == null) return RedirectToAction("Create", "BooksIssues");
